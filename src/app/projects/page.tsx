      ...
      <div className="max-w-5xl mx-auto px-6 sm:px-8">
        <header className="mb-12 text-center">
          ...
          <p className="mt-6 text-zinc-600 text-lg max-w-2xl mx-auto">
            Kumpulan proyek yang telah saya kembangkan. Eksplorasi karya dan
            solusi teknologi yang telah saya buat untuk berbagai kebutuhan.
          </p>
        </header>
              ...
              >
                <div className="relative w-full h-60">
                  <Image
                    ...
                    alt={project.name}
                    className="object-cover rounded-t-3xl hover:scale-105 transition-transform duration-500"
                    fill
                    priority
                  />
                </div>
                <div className="p-8">
                  <div className="flex justify-between items-center mb-4">
                    <span
                      className={`inline-block px-4 py-1.5 ${project.color} text-xs rounded-full font-medium border`}
                    >
                      {project.urlDisplay}
                    </span>
                    <a
                  ...
                  <div className="mt-6 flex flex-wrap gap-2">
                    {project.technologies.map((tech) => (
                      <span
                        key={tech}
                        className="text-xs px-3 py-1.5 bg-zinc-100 text-zinc-700 rounded-xl border border-zinc-200"
                      >
                        {tech}
                      </span>
                    ))}
